...
<head>
  ...
  <title>Contactez-nous - NOSTROGUARD</title>
  <!-- Favicon -->
      ...
      <div class="flex flex-wrap -mx-4">
        <div class="w-full md:w-1/2 px-4 mb-10 md:mb-0">
          <div class="glass-card h-full">
            <h2 class="text-3xl font-bold mb-8 text-white">Nos coordonnées</h2>
            ...
            <div class="contact-info">
              <div class="contact-item">
                ...
                <div class="text">
                  <h3>Adresse</h3>
                  <p>2 Rue de la Fourane, 13090 Aix-en-Provence</p>
                </div>
              </div>
        ...
        <div class="w-full md:w-1/2 px-4">
          <form class="glass-card" method="POST">
            <h2 class="text-3xl font-bold mb-8 text-white">Envoyez-nous un message</h2>
            ...
            <div class="form-group">
              <select id="subject" name="subject" required>
                ...
                <option value="test">Test d'intrusion</option>
            ...
            <button type="submit" class="cyber-button mt-6 w-full">
              Envoyer
    ...
    <div class="container mx-auto px-6">
      <div class="text-center">
        ...
        <div class="mt-8 text-sm text-gray-400">
          © 2025 NOSTROGUARD. Tous droits réservés.
        </div>
      </div>
    </div>
  </footer>
  <!-- Loader JS - Place right before closing body tag -->
